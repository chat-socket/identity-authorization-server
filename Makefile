REPO=identity-authorization-server
TIMESTAMP=tmp-$(shell date +%s )
DFILE=identity-authorization-server/deployment.yml
SFILE=identity-authorization-server/svc.yml
VERSION=v1
TEST_PATH=Documents/projects/microservices-chat-app/identity-authorization-server
